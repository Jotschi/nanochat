...
public class AnfrageGeneratorTest extends AbstractGeneratorTest {
	...
	public void testSingleAnfrage() {
		...
		AnfrageGenerator gen = new AnfrageGenerator(vllm, model);
	...
	public void testAnfrage() throws IOException {
		...
		LLMProvider llm = new OllamaLLMProvider();
		for (int i = 0; i < 10; i++) {
...
//			System.out.println(json.encodePrettily());
			...
			AnfrageResult result = gen.generateTriggerQuestion(story, List.of(word_1, word_2));
			System.out.println("OK: " + result.anfrage() + " | " + result.word1() + " | " + result.word2());
		}
