...
public class QuestionBeginningListGeneratorTest extends AbstractGeneratorTest {

	String promptStr = """
			Erstelle eine Liste von 10 kreativen Satzanfängen (Nur die ersten drei Wörter).
			Lass dir kreative Anfrageanfänge für Anfragen zur Erstellung zu einer Weltraum Kindergeschichte einfallen die ein Kind stellen könnte.
			Erstelle keine Anfänge von der Geschichte selbst.

			Sei kreativ. Verwende auch ungewöhnliche Anfänge.

			Gib die Liste als JSON aus:
			{
				"anfänge": ["Kannst du bitte", "Schreib mir eine", "Erzähl von dem", "Erfinde eine tolle", "Lass uns die", "Träume von vier"];
			}
			""";

	@Test
	public void testQuestionBeginnings() throws IOException {

		File destFile = new File("dataset", "question_beginnings.lst");
