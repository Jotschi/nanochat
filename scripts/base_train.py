...
parser.add_argument("--hf-compatible", action="store_true", help="restrict the architecture to what transformers' NanoChat models, so the checkpoint can be exported and served by vLLM (see vllm/README.md)")
